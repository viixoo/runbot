...
class BuildError(models.Model):
    ...
    fixing_date_forwardports = fields.Datetime('Fixing date', help="Date of the merge of the last forwardport")
    ...
    breaking_bundle_url = fields.Char('Fixing bundle url', related='fixing_bundle_id.frontend_url')
